  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <p class="card-category">Store new user</p>
      </div>
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo genUrl('users.store'); ?>">
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="password" required="true" class="form-control" name="confirmed_password" id="confirmed_password">
              </div>
            </div>
          </div>
